...
#' @param IDSp boolean ; default \code{TRUE}. If \code{TRUE}, print the identification number assigned to the studied species. If \code{FALSE}, doesn't print the identification number assigned to the studied species.
#' @param NameSp character string ; the name of the studies species. Add the names of the studies species to the title of the graphic.
...
#' @param color1 character string ; default green (#008000) ; the first colour that the user wants for the graphic
#' @param color2 character string ; default red (#B40000) ; the second colour that the user wants for the graphic
#'
