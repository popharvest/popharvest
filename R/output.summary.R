...
#'   \item \code{percent2.5.PEG} 2.5% pencentile of the potential excess growth
#'   \item \code{percent97.5.PEG} 97.5% percentile of the potential excess growth
...
#'   \item \code{percent2.5.PTL} 2.5% pencentile of the maximum theoretical harvest
#'   \item \code{percent97.5.PTL} 97.5% percentile of the maximum theoretical harvest
...
#'   \item \code{percent2.5.SHI} 2.5% pencentile of the sustainability harvest index
#'   \item \code{percent97.5.SHI} 97.5% percentile of the sustainability harvest index
...
output.summary <- function(data){
  ...
  for (j in levels(data$code)){
    ...
    if(length(col)> 0){ # If TRUE, the PEG function was used previously
      ...
      percent2.5.PEG <- quantile(newdata$PEG, probs=0.025)
      percent97.5.PEG <- quantile(newdata$PEG, probs=0.975)
    } # End of condition
    ...
    if(length(col)> 0){ # If TRUE, the PEG function was used previously
      ...
      percent2.5.PTL <- quantile(newdata$PTL, probs=0.025)
      percent97.5.PTL <- quantile(newdata$PTL, probs=0.975)
    } # End of condition
    ...
    percent2.5.SHI <- quantile(newdata$SHI, probs=0.025)
    percent97.5.SHI <- quantile(newdata$SHI, probs=0.975)
