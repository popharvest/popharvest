...
#' @param surv.j number, default 1 ; fixed estimate of juvenile annual survival rate provided by the user. It is used to estimate adult survival rate from body mass.
