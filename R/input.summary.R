#' Summary of input parameters used by \code{PEG} and \code{PTL} functions
#'
...
#'
#' @param data dataframe from \code{PEG} and \code{PTL} functions input data. Other inputs will give an error.
#'
#' @return A dataframe with parameters and dispersion statistics in rows. Species(SP), safety factor (Fs) or objective factor (Fobj) are in column :
#' In rows :
#' \itemize{
