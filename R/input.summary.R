...
#'   \item \code{percent2.5.lambdaMax} 2.5% pencentile of maximum annual growth rate
#'   \item \code{percent97.5.lambdaMax} 97.5% percentile of maximum annual growth rate
